/* 
   ...
   Usage:
     sender.exe <receiver_ip> <receiver_port> <window_size> <timeout_ms> <loss_percent>
   Example:
     sender.exe 127.0.0.1 5000 4 1000 10
*/
...
void do_send_packet(int seq) {
    ...
    int sent = sendto(sockfd, out, sizeof(Packet), 0, (struct sockaddr*)&servaddr, sizeof(servaddr));
